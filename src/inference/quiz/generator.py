...
- 강의 내용에 무엇이 있었는지보다, 강의를 통해 학생이 학습한 내용을 확인하는 문제를 출제하세요
- 보기는 그럴듯하고 변별력이 있어야 합니다
- "해당 없음", "위의 모두" 같은 보기는 사용하지 마세요
- 여러 문제를 생성할때, 보기 중 정답 인덱스가 랜덤하게 배치되게 구성하세요
- 각 문제에 정답에 대한 해설을 작성하세요
- 해설은 제 3자 입장에서 설명하듯이 "강의에서는 ~~라고 합니다" 보다는, 학생에게 직접 설명해주는 톤이 권장됩니다
